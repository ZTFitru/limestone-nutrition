function ProductCard({ name, image, price, bg }) {
    return (
      <div className="flex flex-col items-center text-white p-4 w-64 rounded-xl relative mt-10 mb-10 transform transition duration-300 hover:scale-105 cursor-pointer">
